...
Just before pushing your JenkinsFile make sure the mirror set in settings.xml file at /src/main/config point to your local Nexus in order to save build time
